...
\begin{definition} 
	...
	of $G$ is a function $\chi: V(G)\rightarrow \Sigma$. 
	...
	that for any $v\in V(G_1)$, $\chi_1(v)=\chi_2(f(v))$.
	A $\Sigma$ automorphism of a $\Sigma$-hypergraph $G$ is a 
	$\Sigma$-isomorphism from $G$ to itself.
	\par
	Let $(H,\chi_1), (G,\chi_2)$ be two $\Sigma$-hypergraphs. 
...
\begin{proof}
	...
	(O_1,\dots, O_k) \subset G_n
	\big) =
	\Ln |\Omega^{\times}_n|	\mathrm{Pr}\big(
